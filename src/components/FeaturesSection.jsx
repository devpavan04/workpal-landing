...
const FeatureList = [
  {
    ...
    description:
      "Schedule your meetings ahead of time and sync them with your calendar for a better experience.",
  },
  {
    ...
    description:
      "Record every meeting even when you're in a hurry with the press of a button.",
  },
  {
    ...
    description:
      "After recording, you will get the transcript, the summary and task list based on the meeting.",
  },
  {
    title: "Export Tasks",
    ...
    description:
      "Export the desired tasks and organize them on your favorite management tool.",
  },
  {
    title: "Ask RobotPal",
    ...
    description:
      "RobotPal, your virtual assistant, will answer any question you have regarding your meetings.",
  },
];
  ...
  return (
    <div className={"flex flex-col justify-center items-center gap-[12px] lg:gap-[150px] w-[100%]" + desktopStyle}>
      ...
      <div className="flex flex-col gap-[18px] lg:gap-[5px] lg:w-[430px] ">
        <div
          className={
            "flex justify-center items-center gap-[18px]" +
            titleRowStyle +
            " lg:flex-col"
          }
        >
    ...
    <div>
      <div>
        <div className="section-header mb-[30px] mt-[30px] lg:mb-[84px] lg:mt-[80px]">
          ...
          <p className="font-regular text-[18px] mt-[18px] text-center">
